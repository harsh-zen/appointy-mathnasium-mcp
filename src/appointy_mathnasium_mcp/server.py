...
def _build_codefac_log_search_work_item(prompt: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "- Do not ask follow-up questions or pause for user input.",
            ...
            "- If the investigation cannot be fully completed, still finish and include what could not be verified in the report.",
            "",
